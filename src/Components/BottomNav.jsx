    ...
    <div className="fixed bottom-0 left-0 right-0 bg-black/95 backdrop-blur-md border-t border-[#2f3336] flex justify-around items-center py-2.5 z-50 sm:hidden">
      ...
      <button
        ...
        className={`p-2 transition cursor-pointer ${
          currentView === 'home' ? 'text-[#1d9bf0]' : 'text-gray-400'
        }`}
        title="Home"
      >
      ...
      <button
        ...
        className={`p-2 transition cursor-pointer ${
          currentView === 'messages' ? 'text-[#1d9bf0]' : 'text-gray-400'
        }`}
        title="Messages"
      >
      ...
      <button
        ...
        className={`p-2 transition cursor-pointer ${
          currentView === 'games' ? 'text-[#1d9bf0]' : 'text-gray-400'
        }`}
        title="Games"
      >
      ...
      <button
        ...
        className={`p-2 transition cursor-pointer ${
          currentView === 'profile' ? 'text-[#1d9bf0]' : 'text-gray-400'
        }`}
        title="Profile"
      >
