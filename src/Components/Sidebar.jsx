  ...
  return (
    <div className="hidden sm:flex flex-col justify-between h-screen sticky top-0 w-16 xl:w-64 p-2 xl:p-4 select-none flex-shrink-0">
      <div className="flex flex-col items-center xl:items-start space-y-2">
        ...
        {/* Home Navigation */}
        <div onClick={() => setCurrentView('home')} className={`flex items-center gap-4 p-3 hover:bg-white/10 rounded-full cursor-pointer w-full text-xl transition ${
        ...
        {/* Messages Navigation */}
        <div onClick={() => setCurrentView('messages')} className={`flex items-center gap-4 p-3 hover:bg-white/10 rounded-full cursor-pointer w-full text-xl transition ${
        ...
        <div onClick={() => setCurrentView('games')} className={`flex items-center gap-4 p-3 hover:bg-white/10 rounded-full cursor-pointer w-full text-xl transition ${
        ...
        {/* Profile Navigation */}
        <div onClick={() => setCurrentView('profile')} className={`flex items-center gap-4 p-3 hover:bg-white/10 rounded-full cursor-pointer w-full text-xl transition ${
      ...
      {user && (
        <div className="flex items-center justify-between p-2 hover:bg-white/10 rounded-full w-full">
          ...
          <div className="w-10 h-10 rounded-full bg-[#1d9bf0] flex items-center justify-center font-bold text-white uppercase">
          ...
          <button onClick={onLogout} title="Log out" className="text-gray-400 hover:text-red-500 p-2 transition cursor-pointer">
